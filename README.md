...
| File | What it covers |
|---|---|
| [`AI_Card_Lifecycle_Opportunities.pptx`] | Stage-by-stage map of where AI creates efficiency across the card lifecycle |
...
[def]: ./AI_Card_Lifecycle_Opportunities.pptx